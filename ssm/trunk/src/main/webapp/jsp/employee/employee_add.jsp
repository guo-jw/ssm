            ...
            $.ajax({
                ...
                success: function(data){
                    if(data.toString()=="success"){
                        alert("添加成功!");
                        window.location.href = "${pagePath}/jsp/employee/employee_add.jsp";
                    }else {
                        alert("添加失败!");
                    }
                },
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="${pagePath}/images/pointer.gif">&nbsp;当前位置：添加员工信息</td>
                    ...
                    <tr>
                        <td class="font3 fftd">
                            <table>
                                ...
                                <tr>
                                    <tr>
                                        <td class="font3 fftd">员 工 姓 名：<input type="text" name="applicant" id="applicant" value="" size="20"/>
                                    ...
                                    <tr>
                                        <td class="font3 fftd">人 资  编 码：<input type="text" name="code_num" id="code_num" value="" size="20"/></td>
                                        <td class="font3 fftd">公 司  名 称：<input type="text" name="company" id="company" value="" size="20"/></td>
                                    </tr>
                                    <tr>
                                        <td class="font3 fftd">联 系  电 话：<input type="text" name="phone_num" id="phone_num" value="" size="20"/></td>
                                    </tr>
                            </table>
                        </td>
                    </tr>
